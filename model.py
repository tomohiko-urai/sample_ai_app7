...
def main():
    ...
    X_train, X_test, y_train, y_test = np.load("/content/shinemuscat_color_makedata2.npy",allow_pickle=True)
    #### 20220903 X_train, X_test, y_train, y_test = np.load("/content/tomato_color1_makedata2.npy",allow_pickle=True)
